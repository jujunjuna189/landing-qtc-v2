<template>
    <div class="py-10 lg:py-20 relative">
                <img :src="asset.ptCircle" alt="PattrenQTCDesign" class="animate-spin-slow absolute -z-10 -top-[20rem] -right-[20rem] w-[60%] opacity-10 " />
                ...
                <div class="lg:grid lg:grid-cols-2 px-5 lg:px-32 mt-5 lg:mt-12">
                    <div class="lg:pr-20 lg:flex lg:flex-col">
                        ...
                        <div class="mt-5 lg:mt-28 lg:mb-16 lg:grow bg-primary-dark py-5 lg:py-10 px-5 lg:px-10">
                            <span class="text-xl text-white-light font-semibold">{{language[5]}}</span>
                            <div class="w-12 h-1 bg-secondary-dark" />
                            <hr class="my-5 lg:my-10 border-gray-dark" />
                            <div class="">
                                <span class="text-xl text-white-light font-semibold">{{language[6]}}</span>
                            ...
                            <hr class="my-5 lg:my-10 border-gray-dark" />
                            <span class="text-xl text-white-light font-semibold">{{language[7]}}</span>
