<template>
    <div class="pt-10 lg:pt-56 pb-10 lg:pb-32 relative flex flex-col-reverse lg:flex-row overflow-hidden">
        <img :src="asset.ptCircle" alt="PattrenQTCDesign" class="animate-spin-slow absolute -z-10 -top-[10rem] -right-[30rem] w-[60%] opacity-10 " />
        <div class="lg:flex-1 lg:h-full">
            <div class="px-5 lg:px-20">
                <span class="text-xl lg:text-2xl text-primary-dark font-medium">{{language[2]}}</span>
                <div class="w-12 h-1 bg-secondary-dark" />
            </div>
            <div class="lg:flex lg:flex-col px-5 lg:px-20 mt-5 lg:mt-16">
                <span class="text-xl lg:text-4xl text-primary-dark font-semibold">{{language[3.1]}}</span>
                <span class="text-xl lg:text-4xl text-primary-dark font-semibold">{{language[3.2]}}</span>
            </div>
            <div class="lg:flex lg:flex-col gap-6 px-5 lg:px-20 mt-5 lg:mt-12">
                <p class="text-primary-dark mt-4 lg:mt-0">
                    {{language[4]}}
                </p>
                <p class="text-primary-dark mt-4 lg:mt-0">
                    {{language[5]}}
