<template>
    <div class="bg-primary-dark py-10 mt-10 lg:mt-24 px-5 lg:px-20 lg:relative">
        <span class="text-xl lg:text-4xl text-white-light font-semibold">{{language[15]}}</span>
        ...
        <div class="lg:flex lg:flex-row lg:justify-between">
            <div class="flex flex-col gap-1 mt-5 lg:mt-20 lg:flex-1">
                <span class="text-xl lg:text-4xl text-white-light font-semibold">{{language[16]}}</span>
                <span class="text-xl lg:text-4xl text-white-light font-semibold">{{language[17]}}</span>
            </div>
