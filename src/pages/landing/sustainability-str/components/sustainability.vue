<template>
    ...
    <div class="relative lg:flex lg:gap-20 lg:px-5 lg:px-20">
        <div class="lg:w-72 lg:min-w-72 mx-5 lg:mx-0 lg:max-w-72">
            <ul>
                <li class="pl-5 pr-20 py-2 text-sm lg:text-base hover:bg-white-muted text-primary-dark border-b cursor-pointer border-primary-dark font-semibold" @click="router.push(RouterName.sustainabilityCommitment)">Commitment</li>
                <li class="pl-5 pr-20 py-2 text-sm lg:text-base bg-primary-dark border-b cursor-pointer border-primary-dark text-white-light font-semibold" @click="router.push(RouterName.sustainabilityStrategic)">Our Strategic at QTC</li>
                <li class="pl-5 pr-20 py-2 text-sm lg:text-base hover:bg-white-muted text-primary-dark border-b cursor-pointer border-primary-dark font-semibold" @click="router.push(RouterName.sustainabilityPartnerships)">Partnerships</li>
            </ul>
        </div>
