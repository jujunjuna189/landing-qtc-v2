    ...
    >
      <ul>
        <li
          ...
          @click="router.push(RouterName.sustainabilityCommitment)"
          @mouseover="hoverText = language[4.1]"
        ...
        <li
          class="py-3 cursor-pointer animate-fade animate-duration-400 hover:font-semibold text-sm lg:text-xl whitespace-pre"
          @click="router.push(RouterName.sustainabilityStrategic)"
          @mouseover="hoverText = language[4.2]"
          @mouseleave="hoverText = '-'"
        >
          {{ language[4.2] }}
        </li>
        <li
          class="py-3 cursor-pointer animate-fade animate-duration-400 hover:font-semibold text-sm lg:text-xl whitespace-pre"
          @click="router.push(RouterName.sustainabilityPartnerships)"
          @mouseover="hoverText = language[4.3]"
          @mouseleave="hoverText = '-'"
        >
          {{ language[4.3] }}
        </li>
      ...
      <div class="lg:w-[80%] px-20 hidden lg:flex justify-center pl-20">
        <div>
          ...
          <div class="mt-10">
            <img
              :src="asset.imgSustainability"
              alt="SustainabilityImage"
...
const hoverText = ref(language[4]) // Default text
</script>
